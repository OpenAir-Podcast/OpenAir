...
class DownloadsEpisodeCardList extends ConsumerStatefulWidget {
  final Map<String, dynamic> episodeItem;
  final String title;
  final PodcastModel podcast;

  const DownloadsEpisodeCardList({
    super.key,
  ...
  @override
  ConsumerState<DownloadsEpisodeCardList> createState() =>
      _EpisodeCardListState();
}

class _EpisodeCardListState extends ConsumerState<DownloadsEpisodeCardList> {
  String podcastDate = "";

...
class DownloadsEpisodeCardNarrow extends ConsumerStatefulWidget {
  final Map<String, dynamic> episodeItem;
  final String title;
  final PodcastModel podcast;

  const DownloadsEpisodeCardNarrow({
    super.key,
  ...
  @override
  ConsumerState<DownloadsEpisodeCardNarrow> createState() =>
      _EpisodeCardNarrowState();
}

class _EpisodeCardNarrowState
    extends ConsumerState<DownloadsEpisodeCardNarrow> {
  String podcastDate = "";

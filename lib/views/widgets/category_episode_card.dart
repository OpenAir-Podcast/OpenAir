...
class CategoryEpisodeCard extends ConsumerStatefulWidget {
  final Map<String, dynamic> episodeItem;

  const CategoryEpisodeCard({
    super.key,
    required this.episodeItem,
  });

  @override
  ConsumerState<CategoryEpisodeCard> createState() => _EpisodeCardState();
}

class _EpisodeCardState extends ConsumerState<CategoryEpisodeCard> {
  String podcastDate = "";

...
class DownloadsEpisodeCardWide extends ConsumerStatefulWidget {
  final Map<String, dynamic> episodeItem;
  final String title;
  final PodcastModel podcast;

  const DownloadsEpisodeCardWide({
    super.key,
  ...
  @override
  ConsumerState<DownloadsEpisodeCardWide> createState() =>
      _EpisodeCardWideState();
}

class _EpisodeCardWideState extends ConsumerState<DownloadsEpisodeCardWide> {
  String podcastDate = "";
                        ...
                        children: [
                          ...
                          queueListAsync.when(
                            data: (data) {
                              ...
                              return IconButton(
                                tooltip:
                                    Translations.of(context).text('addToQueue'),
                                onPressed: () {
                                  isQueued
                            ...
                            downloadedListAsync.when(
                              data: (downloads) {
                                ...
                                // Not downloaded
                                  ...
                                  tooltip =
                                      Translations.of(context).text('download');
